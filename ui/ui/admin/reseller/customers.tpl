    ...
    <div class="col-sm-12">
        <div class="panel panel-hovered mb20 panel-primary">
            ...
            <div class="panel-body">
                <form id="site-search" method="get" action="{Text::url('reseller/customers')}">
                    <input type="hidden" name="_route" value="reseller/customers">
                    ...
                    <div class="md-whiteframe-z1 mb20 text-center" style="padding: 15px">
                        ...
                        <div class="col-lg-3">
                            <div class="input-group">
                                ...
                                <select class="form-control" id="filter" name="filter">
                                    <option value="all" {if $filter eq 'all' }selected{/if}>All Status</option>
                        ...
                        <div class="col-lg-1">
                            <a href="{Text::url('reseller/customer-add')}" class="btn btn-success text-black btn-block"
                                title="{Lang::T('Add')}">
                    ...
                    <table id="customerTable" class="table table-bordered table-striped table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr {if $ds['status'] !='Active' }class="danger" {/if}>
                                <td onclick="window.location.href = '{Text::url('reseller/customer-view/')}{$ds['id']}'"
