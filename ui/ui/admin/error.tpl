...
<head>
    ...
    <title>Error - Arivo ISP Billing</title>
                    ...
                    <div class="box box-danger box-solid">
                        ...
                        <div class="box-body" style="font-size: larger;">
                            ...
                            <ul>
                                ...
                                <li>{Lang::T('Make sure your Mikrotik accessible from Arivo ISP Billing')}</li>
                            </ul>
                            {Lang::T('If you just update Arivo ISP Billing from upload files, try click Update')} Database
                        </div>
                        <div class="box-footer">
                            <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                <a href="./update.php?step=4" style="color: black;" class="btn btn-info btn-sm btn-block">{Lang::T('Update')} Database</a>
                                <a href="{Text::url('community#update')}" style="color: black;" class="btn btn-success btn-sm btn-block">{Lang::T('Update Arivo ISP Billing')}</a>
                            </div>
                            <br>
                            <div class="btn-group btn-group-justified" role="group" aria-label="...">
                            <a href="https://github.com/mahin-wpdev/panel/issues" target="_blank"
